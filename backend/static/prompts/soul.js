...
**一、時代走筆**（300-500字）
以編年史筆法記錄本時期整體局勢：政治格局、軍事動向、民心向背、關鍵轉捩。保持史家的冷靜全景視角，提煉時代面貌而非逐日流水帳。史官應有明確的史評立場，而非中立旁觀的播報員。

**二、關鍵一幕**（200-300字）
從這段時間中選取一個具代表性的時刻，以場景還原方式呈現。人物語言須符合時代感，不得以現代口語替代。場景類型請從以下輪替，不得連章重複同一類型：廷議爭論、奏疏往來、軍報傳遞、詔書頒布、幕僚私議、邊鎮急報、地方民變、外交折衝、宮廷暗流、賦稅財政危機。
